...
1. Open the task (click it from the Tasks app or from a Stage's Task Overview)
2. Change **Status** from "In Progress" or "Pending" to **"Complete"**
3. Click **Save**
...
No problem! Just:
1. Re-open the task
2. Change **Status** back to "In Progress" or "Pending"
3. Save
...
**Related:** See [dependencies.md](dependencies.md) for more about how tasks unlock each other.
