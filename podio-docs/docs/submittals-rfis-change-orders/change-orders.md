...
2. Navigate to the appropriate **Stage** (usually Construction)
3. In the **Task Overview**, click **"Add Task"**
...
1. **What changed:** Describe the extra work or condition clearly
2. **Why it's extra work:** Reference the original contract/drawings to show this wasn't included
3. **Impact:** How much extra time/cost it will add
4. **When requested:** Date the GC asked for it (or when you discovered the condition)
5. **Reference numbers:** Link to related RFIs, emails, or meeting notes
